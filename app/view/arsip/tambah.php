...
<html lang="en">
    ...
    <head>
        ...
        <title>Dashboard Tambah Arsip</title>
            ...
            <div class="panel-body rounded-2 container-fluid">
                <div class="panel-heading text-dark">
                    ...
                    <div class="breadcrumb d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                            <a href="?aksi=arsip-tambah" aria-current="page" class="text-decoration-none active">Tambah
                                Arsip</a>
                        </li>
                    </div>
                </div>
                                ...
                                <div class="card-body my-2">
                                    <div class="d-flex justify-content-center align-items-center flex-wrap">
                                        <div class="card shadow my-3 bg-secondary col-sm-9 col-md-9">
                                            ...
                                            <div class="card-body my-2">
                                                <form action="?aksi=tambah-arsip" method="post">
                                                        ...
                                                        <div class="form-inline row flex-wrap
                                                            ...
                                                            <div class="col-sm-6 col-md-6">
                                                                <input type="text" name="kode_rak" required
                                                                    ...
                                                                    placeholder="Kode Rak" id="kode_rak">
                                                        ...
                                                        <div class="form-inline row flex-wrap
                                                            ...
                                                            <div class="col-sm-6 col-md-6">
                                                                <input type="text" name="kode_box" required
                                                                    class="form-control" maxlength="30"
                                                                    placeholder="Kode Box" id="kode_box">
                                                                <div
                                                        ...
                                                        <div class="form-inline row flex-wrap
                                                            ...
                                                            <div class="col-sm-6 col-md-6">
                                                                <input type="text" name="kode_ordner" required
                                                                    class="form-control" maxlength="30"
                                                                    placeholder="Kode Ordner" id="kode_ordner">
                                                                <div class="d-flex justify-content-between
                                                                     align-items-center flex-wrap">
                                                        ...
                                                        <div class="form-inline row flex-wrap
                                                            ...
                                                            <div class="col-sm-6 col-md-6">
                                                                <input type="text" name="kode_arsip" required
                                                                    ...
                                                                    placeholder="Kode Arsip" id="kode_arsip">
                                                                <div class="d-flex justify-content-between
                                                                     align-items-center flex-wrap">
                                                        ...
                                                        <div class="form-inline row flex-wrap
                                                            ...
                                                            <div class="col-sm-6 col-md-6">
                                                                <input type="text" name="no_akun" required
                                                                    class="form-control" maxlength="30"
                                                                    placeholder="No Akun" id="no_akun">
                                                        ...
                                                        <div class="form-inline row flex-wrap
                                                            ...
                                                            <div class="col-sm-6 col-md-6">
                                                                <input type="kegiatan" name="kegiatan" required
                                                                    class="form-control" maxlength="200"
                                                                    placeholder="Kegiatan" id="kegiatan">
                                                        ...
                                                        <div class="form-inline row flex-wrap
                                                            ...
                                                            <div class="col-sm-6 col-md-6">
                                                                <input type="text" placeholder="Status Arsip"
                                                                    name="status_arsip" maxlength="50" required
                                                                    class="form-control" id="status_arsip">
